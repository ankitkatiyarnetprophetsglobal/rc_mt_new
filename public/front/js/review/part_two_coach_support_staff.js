...
$(document).on('click', '.add_more_two_part_two_coach_support_staff', function () {
    ...
    var two_part_two_coach_support_staff_html = `<tr class="row_${counting_2}">
            ...
            <td>
                <input type="text required" class="form-control" name='coach_support_staff_form[${counting_2}][coach_support_staff_name_designation]'>
            </td>
            <td>
                <input type="text required" class="form-control" name='coach_support_staff_form[${counting_2}][coach_support_staff_period_tour]'>
            </td>
            <td>
                <input type="text required" class="form-control" name='coach_support_staff_form[${counting_2}][coach_support_staff_Remarks]'>
            </td>
            <td>
...
$(document).on('click', '.part_two_field_of_play_add', function () {
    ...
    var two_part_two_play_field_html = `<tr class="row_${counting_11}">
            <td>
                ...
                <select required class="form-select form_1_discipline_${counting_11} form_1_discipline disciplin_grab" required data-id="form_1" data-counting_id="${counting_11}" aria-label="Default select example" name='part_two_play_field[${counting_11}][discline_play_field]'>
                                        <option disabled selected value="">Select</option>
                ${getDisciplineHtml(data_dict.form1)}
                  </select>
            </td>
            <td><input type="text required" class="form-control" name='part_two_play_field[${counting_11}][no_fop_play_field]' ></td>
            <td>
            <select required class="form-select" aria-label="Default select example" name='part_two_play_field[${counting_11}][fop_play_field]'>
                <option value="1">Indoor</option>
                <option value="2">Outdoor</option>
            </select>
            </td>
            <td>
                <select required class="form-select"  name='part_two_play_field[${counting_11}][fop_surface_play_field]'  aria-label="Default select example">
            ...
            <td>
                ...
                <select required class="form-select"  name='part_two_play_field[${counting_11}][rating_play_field]'  aria-label="Default select example">
                                     <option selected>Select</option>
            ...
            <td>
                <input type="text required" class="form-control" name='part_two_play_field[${counting_11}][remark_play_field]'>
            </td>
            <td>
...
$(document).on('click', '.remove_two_play_field_remove', function () {
    // let discipline_id = $(`.form_1_discipline_${$(this).data("id11")} option:selected`).val();
    // let discipline = $(`.form_1_discipline_${$(this).data("id11")} option:selected`).text();
    // console.log(discipline_id + '  ' + discipline);
    ...
    if ($(this).data("db_id11") != undefined) {
        ...
        $.ajax({
            method: "GET",
            url: baseurl + "/review/play_field_ById/" + $(this).data("db_id11"),
            contentType: false,
            processData: false,
            ...
            success: function (response) {
                ...
                if (response.success == false) {
                    ...
                    swal("Message", response.message, "success").then(() => {
                        ...
                        window.location.href = baseurl + "/review/part-two/" + encoded_cid;
...
$(document).on('click', '.remove_coach_support_staff_form', function () {
    // let discipline_id = $(`.form_2_discipline_${$(this).data("db_id2")} option:selected`).val();
    // let discipline = $(`.form_2_discipline_${$(this).data("db_id2")} option:selected`).text();
    // console.log(discipline_id + '  ' + discipline);
    // if (discipline != 'Select') {
    //     data_dict.form1[discipline_id] = { "discipline_id": discipline_id, "discipline": discipline };
...
$(document).on('click', '.add_more_two_part_two_athletes', function () {
    ...
    var two_part_two_athletes_html = `<tr class="row_${counting_1}">
            ...
            <td>
            <select required required class="form-select  form_1_discipline_${counting_1} form_1_discipline disciplin_grab " data-id="form_1" data-counting_id="${counting_play_field}" name="two_part_two_athletes[${counting_play_field}][athletes_discipline]"  aria-label="Default select example">

                ${getDisciplineHtml(data_dict.form1)}
                  </select>
            </td>
            <td>
                <input type="text required" class="form-control" name='two_part_two_athletes[${counting_1}][athletes_no_athletes_participated]'>
            </td>
            <td>
                <input type="text required" class="form-control" name='two_part_two_athletes[${counting_1}][athletes_no_expenditure_incurred]'>
            </td>
            <td>
                <input type="text required" class="form-control" name='two_part_two_athletes[${counting_1}][athletes_no_achievements]'>
            </td>
            <td>
                <input type="text required" class="form-control" name='two_part_two_athletes[${counting_1}][athletes_no_remarks]'>
            </td>
            <td>
...
$(document).on('click', '.remove_two_part_two_athletes', function () {
    // let discipline_id = $(`.form_1_discipline_${$(this).data("db_id2")} option:selected`).val();
    // let discipline = $(`.form_1_discipline_${$(this).data("db_id2")} option:selected`).text();
    // console.log(discipline_id + '  ' + discipline);
    // if (discipline != 'Select') {
    //     data_dict.form1[discipline_id] = { "discipline_id": discipline_id, "discipline": discipline };
...
$(document).on('click', '.add_more_two_part_residential_coaches', function () {
    ...
    var two_part_residential_coaches_html = `<tr class="row_${counting_3}">
            <td>
                <input type="hidden" class="center_id" name="two_part_residential_coaches[${counting_3}][center_id]" value="${center_id}">
                <select required required class="form-select  form_1_discipline_${counting_3} form_1_discipline disciplin_grab " data-id="form_1" data-counting_id="${counting_3}" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_discipline_id]"  aria-label="Default select example">
                ${getDisciplineHtml(data_dict.form1)}
                </select>
            </td>
            <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2018_19_resi_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2018_19_resi_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2018_19_nr_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2018_19_nr_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2018_19_nr_c]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2019_20_resi_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2019_20_resi_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2019_20_nr_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2019_20_nr_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2019_20_nr_c]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2020_21_resi_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2020_21_resi_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2020_21_nr_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2020_21_nr_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2020_21_nr_c]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_22_resi_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_22_resi_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_22_nr_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_22_nr_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_22_nr_c]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_23_resi_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_23_resi_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_23_nr_m]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_23_nr_f]">
                                    </td>
                                    <td>
                                        <input type="number" required  min="0" class="form-control" style="width:80px;" name="two_part_residential_coaches[${counting_3}][strength_residential_coaches_2022_23_nr_c]">
                                    </td>
...
$(document).on('click', '.remove_two_part_residential_coaches', function () {
    // let discipline_id = $(`.form_1_discipline_${$(this).data("db_id3")} option:selected`).val();
    // let discipline = $(`.form_1_discipline_${$(this).data("db_id3                                                                                                                                                                                                                                                                                                                            ")} option:selected`).text();
    // console.log(discipline_id + '  ' + discipline);
    // if (discipline != 'Select') {
    //     data_dict.form1[discipline_id] = { "discipline_id": discipline_id, "discipline": discipline };
...
$(document).on('click', '.remove_two_part_staff_nutritionist_chef', function () {
    // let discipline_id = $(`.form_1_discipline_${$(this).data("db_id4")} option:selected`).val();
    // let discipline = $(`.form_1_discipline_${$(this).data("db_id4")} option:selected`).text();
    // console.log(discipline_id + '  ' + discipline);
    // if (discipline != 'Select') {
    //     data_dict.form1[discipline_id] = { "discipline_id": discipline_id, "discipline": discipline };
...
$(document).on('click', '.add_more_sport_science_staff_doctor', function () {
    ...
    var two_part_sport_science_staff_doctor_html = `<tr class="row_${counting_5}">
            ...
            <input type="hidden" class="center_id" name="sport_science_staff_doctor[${counting_5}][center_id]" value="${center_id}">
                <input type="text required" class="form-control" name="sport_science_staff_doctor[${counting_5}][ssd_designation]">
            </td>
            <td>
...
$(document).on('click', '.add_more_two_part_staff_nutritionist_chef', function () {
    ...
    var two_part_staff_nutritionist_chef_html = `<tr class="row_${counting_4}">
            <td>
                ...
                <input type="text required"  class="form-control" name="staff_nutritionist_chef[${counting_4}][snc_designation]">
            </td>
            <td>
...
$(document).on('click', '.field_of_play_add', function () {
    ...
    form_first_html = `<tr class="tr_field_of_play_${counting}" id="main_${counting}">
      <td>
          <select required class="form-select" aria-label="Default select example" name="discline_play_field[]" id="js_${counting}">
    ...
    <td><input type="text required" class="form-control" name="no_fop_play_field[]" id="js_${counting}"></td>
    <td>
      <select required class="form-select" aria-label="Default select example" name="fop_play_field[]" id="js_${counting}">
    ...
    <td><input type="text required" class="form-control" name="fop_surface_play_field[]" id="js_${counting}"></td>
    <td><input type="text required" class="form-control" name="rating_play_field[]" id="js_${counting}"></td>
    <td><input type="text required" class="form-control" name="remark_play_field[]" id="js_${counting}"></td>
    <td>
...
$(document).on('click', '.part_two_add_sport_equipment', function () {
   ...
   <select required class="form-select form_2_discipline_${counting_10} form_2_discipline disciplin_grab" data-id="form_2" data-counting_id="${counting_10}" aria-label="Default     select example" name="two_part_two_equipment[${counting_10}][equipment_discipline]">
   <option disabled selected value="">Select</option>
    ${getDisciplineHtml(data_dict.form1)}
    </select>
              </td>
  ...
  <td>
        <select required class="form-select" id="js_${counting_10}" name="two_part_two_equipment[${counting_10}][equipment_suficient]" aria-label="Default select example">

        <option value="1">Sufficient</option>
        <option value="2">insufficient</option>
        </select>
  </td>
  <td><input type="text required"  id="js_${counting_10}" name="two_part_two_equipment[${counting_10}][equipment_remark]" class="form-control"></td>
  <td>
  <a href="javascript:void(0)" class="actionbtn remove_two_part_two_equipment_none" data-id10="${counting_10}"><i class="fa-solid fa-trash-can"></i></a>
  </td>
...
$(document).on('click', '.part_two_add_sport_equipment_consumable', function () {
    ...
    <select required class="form-select form_2_discipline_${counting_9} form_2_discipline disciplin_grab" data-id="form_3" data-counting_id="${counting_9}" aria-label="Default select example" name="two_part_two_equipment_consumable[${counting_9}][equipment_discipline]" >
    <option disabled selected value="">Select</option>
    ${getDisciplineHtml(data_dict.form1)}
    </select>
    </td>
  ...
  <td>
        <select required class="form-select" id="js_${form_sport_quipment}" name="two_part_two_equipment_consumable[${counting_9}][equipment_suficient]" aria-label="Default select example">

        <option value="1">Sufficient</option>
        <option value="2">insufficient</option>
        </select>
  </td>
  <td><input type="text required"  id="js_${form_sport_quipment}" name="two_part_two_equipment_consumable[${counting_9}][equipment_remark]" class="form-control"></td>
  <td>
...
$(document).on('click', '.part_two_sport_science', function () {
  ...
  <select required required class="form-select  form_1_discipline_${counting_8} form_1_discipline disciplin_grab " data-id="form_1" data-counting_id="${counting_8}" name="two_part_two_sport_science[${counting_8}][science_discipline]"  aria-label="Default select example">
...
${getDisciplineHtml(data_dict.form1)}
  ...
  <td>
        <select required class="form-select" id="js_${counting_8}" name="two_part_two_sport_science[${counting_8}][sport_consumable]" aria-label="Default select example">
  ...
  <td>
        <select required class="form-select" id="js_${counting_8}" name="two_part_two_sport_science[${counting_8}][sport_non_consumable]" aria-label="Default select example">

        <option value="1">Sufficient</option>
        <option value="2">insufficient</option>
        </select>
  </td>
  <td><input type="text required"  id="js_${counting_8}" name="two_part_two_sport_science[${counting_8}][science_remark]" class="form-control"></td>
  <td>
...
$(document).on('click', '.add_add_staff_button', function () {
    ...
    <td>
        ...
        <input type="text required" class="form-control" name="administrative_supports[${counting_7}][ssd_designation]">
    </td>
    <td>
...
$(document).on('click', '.remove_two_part_sports_science_equipment', function () {
    ...
    let center_id = $('.center_id').val();
    var encoded_cid = $(this).data('id_enc');
    ...
    if ($(this).data("db_id8") != undefined) {
        ...
        $.ajax({
            method: "GET",
            url: baseurl + "/review/parttwoformnineById/" + $(this).data("db_id8"),
            contentType: false,
            processData: false,
...
$(document).on('click', '.remove_two_part_sports_equipment', function () {
    ...
    if ($(this).data("db_id9") != undefined) {
        ...
        $.ajax({
            method: "GET",
            url: baseurl + "/review/parttwoformeighttById/" + $(this).data("db_id9"),
            contentType: false,
            processData: false,
...
$(document).on('click', '.part_two_add_sport_equipment2', function () {
    // alert('hello');
    counting_10++;
    ten_form_array_counting.push(counting_10);
    let center_id = $('.center_id').val();
...
$(document).on('click', '.remove_two_part_two_equipment', function () {
    ...
    // var data_enc = $(this).data('id_enc');
    // let discipline_id = $(`.form_2_discipline_${$(this).data("db_id10")} option:selected`).val();
    // let discipline = $(`.form_2_discipline_${$(this).data("db_id10")} option:selected`).text();
    ...
    if ($(this).data("db_id10") != undefined) {
        ...
        $.ajax({
            method: "GET",
            url: baseurl + "/review/partsportsequipmentById/" + $(this).data("db_id10"),
            contentType: false,
            processData: false,
