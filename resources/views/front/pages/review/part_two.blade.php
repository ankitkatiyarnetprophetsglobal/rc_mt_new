                   ...
                   <!-- <h6>(No of athletes who won medal is also to be reflected in Male/ Female)</h6> -->
                       ...
                       <tbody>
                           <tr>
                               ...
                               <td><input type="text" name="accommods_part_two_rooms_remark" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               ...
                               <td><input type="text" name="accommods_part_two_accomodation_capacity_remark" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
