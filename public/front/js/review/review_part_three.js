...
//form one
  $(document).on('click','.discpline_discountinued',function(){
   ...
   <td>
    <select  class="form-select  form_1_discipline_${counting1} form_1_discipline disciplin_grab " data-id="form_1" data-counting_id="${counting1}" name="form_1[${counting1}][dis_dis]"  aria-label="Default select example">
    <option disabled selected value="">Select </option>
    ${getDisciplineHtml(data_dict.form1)}
      </select>
      <input type="hidden" name="form_1[${counting1}][created_for]" value="${c_id}" >
   </td>

   <td>
    <input  type="number" name="form_1[${counting1}][dis_dis_male]" class="form-control" >
   </td>
   <td>
    <input  type="number" name="form_1[${counting1}][dis_dis_female]" class="form-control">
   </td>
   <td>
    <input  type="text" name="form_1[${counting1}][dis_dis_reason]" class="form-control" >
   </td>
   <td>
   ...
   $(document).on('click','.discpline_added_add',function(){
    ...
    <td>
    <select class="form-select  form_2_discipline_${counting2} form_2_discipline disciplin_grab " data-id="form_2" data-counting_id="${counting2}" name="form_2[${counting2}][dis_added]"  aria-label="Default select example">
    <option disabled selected value="">Select </option>
    ${getDisciplineHtml(data_dict.form2)}
      </select>
      <input  type="hidden" name="form_2[${counting2}][created_for]" value="${c_id}" >
   </td>

    <td>
     <input r type="number" name="form_2[${counting2}][dis_added_male]" id="jsd_${counting2}" class="form-control" >
    </td>
    <td>
     <input type="number" name="form_2[${counting2}][dis_added_female]" id="jsd_${counting2}" class="form-control" >
    </td>
    <td>
     <input  type="text" name="form_2[${counting2}][dis_added_reason]" id="jsd_${counting2}" class="form-control" >
    </td>
    <td>
...
$(document).on('click','.discpline_add',function(){
    ...
    <td>
    <select  class="form-select  form_3_discipline_${counting3} form_3_discipline disciplin_grab " data-id="form_3" data-counting_id="${counting3}" name="form_3[${counting3}][strength_discipline]"  aria-label="Default select example">
       <option disabled selected value="">Select </option>
         ${getDisciplineHtml(data_dict.form3)}
      </select>
      <input  type="hidden" name="form_3[${counting3}][created_for]" value="${c_id}" >
   </td>

                <td>
                <input  type="number" name="form_3[${counting3}][strength_current_m]" class="form-control" >
                </td>
                <td>
                <input  type="number" name="form_3[${counting3}][strength_current_f]" class="form-control" >
                </td>
                <td>
                <input type="number" name="form_3[${counting3}][pro_sec_strnght_m]" class="form-control" >
                </td>
                <td>
                <input  type="number" name="form_3[${counting3}][pro_sec_strnght_f]" class="form-control" >
                </td>
                <td>
                <input  type="text" name="form_3[${counting3}][strength_discipline_reason]" class="form-control" >
                </td>
                <td>
  ...
  $(document).on('click','.remove_btn_row_discpline',function(){
    ...
    $(document).on('click','.row_Discipline_add',function(){
        ...
        <select required class="form-select  form_4_discipline_${counting4} form_4_discipline disciplin_grab " data-id="form_4" data-counting_id="${counting4}" name="form_4[${counting4}][discipline_coaches]"  aria-label="Default select example">
          ...
          <input  type="hidden" name="form_4[${counting4}][created_for]" value="${c_id}" >
       </td>

                    <td>
                    <input required type="number" name="form_4[${counting4}][coaches_pre_male]" class="form-control" >
                    </td>
                    <td>
                    <input required type="number"   name="form_4[${counting4}][coaches_pre_fmale]" class="form-control" >
                    </td>
                    <td>
                    <input required type="number" name="form_4[${counting4}][coaches_req_male]" class="form-control" >
                    </td>
                    <td>
                    <input required type="number"  name="form_4[${counting4}][coaches_req_fmale]" class="form-control" >
                    </td>
                    <td>
                    <input required type="text" name="form_4[${counting4}][coaches_req_reason]" class="form-control" >
                    </td>
                    <td>
