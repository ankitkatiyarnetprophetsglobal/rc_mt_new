                            ...
                            <tbody id="two_part_residential_coaches_container" class=" align-middle">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select style="width:150px;" class="form-select" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_discipline_id]">
                                            @foreach ($dis_list as $item)
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <select style="width:150px;" class="form-select" name="two_part_residential_coaches[0][strength_residential_coaches_discipline_id]">
                                            @foreach ($dis_list as $item)
                                            <option value="{{$item->discipline_id}}">{{$item ->discipline}}</option>
                                            @endforeach
                                        </select>
