...
<div class="container rc-new-container">
    ...
    <form id="part_two" action ="{{url('review/part-two-store')}}" method="POST">
        ...
        <div class="d-flex">
            ...
            <input class="form-check-input" type="radio" name="cat_radio" id="flexRadioDefault3" @if($data)  @if($data->cat_radio == 'Yes') {{'checked'}} @endif @endif value="Yes">
            <label class="form-check-label" for="flexRadioDefault3">
             Yes
            </label>
            </div>
            <div class="form-check mx-2">
            <input class="form-check-input" type="radio" name="cat_radio" id="flexRadioDefault4" @if($data)  @if($data->cat_radio == 'No') {{'checked'}} @endif @endif value="No">
        ...
        <div class="col-auto">
            <h4 class="text-start my-4">2.2 Area of land</h4>
        </div>
        <div class="col-auto">
           <div class="d-flex">
            <div class="form-check mx-2">
               ...
               <table class="table table-bordered">
                   ...
                   <!-- <h6>(No of athletes who won medal is also to be reflected in Male/ Female)</h6> -->
                       ...
                       <tbody>
                           <tr>
                               <td>No of Rooms*</td>
                               <td><input type="number"  min="0" name = "accommods_part_two_rooms_male_ac" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_male_ac}}" @endif class="form-control"></td>
                               <td>
                               ...
                               <td><input type="number"  min="0"  name="accommods_part_two_rooms_male_nonac" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_male_nonac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_rooms_male_nonacrating" aria-label="Default select example">
                                       <option selected>select</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_rooms_male_nonacrating']) && $accommods['accommods_part_two_rooms_male_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_male_nonacrating']) && $accommods['accommods_part_two_rooms_male_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_male_nonacrating']) && $accommods['accommods_part_two_rooms_male_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_rooms_female_ac" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_female_ac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_rooms_female_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_rooms_female_ac_rating']) && $accommods['accommods_part_two_rooms_female_ac_rating'] == "1") selected @endif>Good</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_female_ac_rating']) && $accommods['accommods_part_two_rooms_female_ac_rating'] == "2") selected @endif >Average</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_female_ac_rating']) && $accommods['accommods_part_two_rooms_female_ac_rating'] == "3") selected @endif >Poor</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_rooms_female_nonac" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_female_nonac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_rooms_female_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_rooms_female_nonacrating']) && $accommods['accommods_part_two_rooms_female_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_female_nonacrating']) && $accommods['accommods_part_two_rooms_female_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_rooms_female_nonacrating']) && $accommods['accommods_part_two_rooms_female_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_rooms_remark" @if($accommods)  value="{{$accommods->accommods_part_two_rooms_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               <td>Total Accomodation Capacity of Rooms</td>
                               <td><input type="number"  min="0" name="accommods_part_two_accomodation_capacity_male_ac" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_male_ac}}" @endif class="form-control"></td>
                               <td>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_accomodation_capacity_male_nonac" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_male_nonac}}" @endif class="form-control"></td>
                               <td>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_accomodation_capacity_female_ac" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_female_ac}}" @endif class="form-control"></td>
                               <td>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_accomodation_capacity_female_nonac" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_female_nonac}}" @endif class="form-control"></td>
                               <td>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_accomodation_capacity_remark" @if($accommods)  value="{{$accommods->accommods_part_two_accomodation_capacity_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               <td>No of Dormitory*</td>
                               <td><input type="number"  min="0" name="accommods_part_two_dormitory_male_ac" @if($accommods)  value="{{$accommods->accommods_part_two_dormitory_male_ac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_dormitory_male_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_dormitory_male_nonacrating']) && $accommods['accommods_part_two_dormitory_male_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_male_nonacrating']) && $accommods['accommods_part_two_dormitory_male_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_male_nonacrating']) && $accommods['accommods_part_two_dormitory_male_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_dormitory_male_nonac" @if($accommods)  value="{{$accommods->accommods_part_two_dormitory_male_nonac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_dormitory_male_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_dormitory_male_nonacrating']) && $accommods['accommods_part_two_dormitory_male_nonacrating'] == "1") selected @endif>One</option>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_dormitory_female_ac" @if($accommods)  value="{{$accommods->accommods_part_two_dormitory_female_ac}}" @endif class="form-control"></td>
                               <td>
                                   <select class="form-select" name="accommods_part_two_dormitory_female_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_dormitory_female_ac_rating']) && $accommods['accommods_part_two_dormitory_female_ac_rating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_female_ac_rating']) && $accommods['accommods_part_two_dormitory_female_ac_rating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_female_ac_rating']) && $accommods['accommods_part_two_dormitory_female_ac_rating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_dormitory_female_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_dormitory_female_nonacrating']) && $accommods['accommods_part_two_dormitory_female_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_female_nonacrating']) && $accommods['accommods_part_two_dormitory_female_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_dormitory_female_nonacrating']) && $accommods['accommods_part_two_dormitory_female_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_dormitory_remark" @if($accommods)  value="{{$accommods->accommods_part_two_dormitory_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               ...
                               <td><input type="number"  min="0" name="accommods_part_two_capacity_dormitory_remark"  @if($accommods)  value="{{$accommods->accommods_part_two_capacity_dormitory_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_attached_male_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_attached_male_ac_rating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_attached_male_ac_rating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_attached_male_ac_rating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_attached_male_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_attached_male_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_attached_male_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_attached_male_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_attached_female_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_attached_female_ac_rating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_attached_female_ac_rating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_attached_female_ac_rating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_attached_female_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_attached_female_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_attached_female_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_attached_female_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_toilet_attached_remark" @if($accommods)  value="{{$accommods->accommods_part_two_toilet_attached_remark}}" @endif class="form-control"></td>
                           </tr>
                           <tr>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_non_attached_male_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_non_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_male_ac_rating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_male_ac_rating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_male_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_male_ac_rating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_non_attached_male_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_non_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_male_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_male_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_male_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_male_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_non_attached_female_ac_rating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_non_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_female_ac_rating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_female_ac_rating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_female_ac_rating']) && $accommods['accommods_part_two_toilet_non_attached_female_ac_rating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               ...
                               <td>
                                   <select class="form-select" name="accommods_part_two_toilet_non_attached_female_nonacrating" aria-label="Default select example">
                                       <option selected>Open this select menu</option>
                                       <option value="1"  @if(isset($accommods['accommods_part_two_toilet_non_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_female_nonacrating'] == "1") selected @endif>One</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_female_nonacrating'] == "2") selected @endif >Two</option>
                                       <option value="2" @if(isset($accommods['accommods_part_two_toilet_non_attached_female_nonacrating']) && $accommods['accommods_part_two_toilet_non_attached_female_nonacrating'] == "3") selected @endif >Three</option>
                                     </select>
                               </td>
                               <td><input type="number"  min="0" name="accommods_part_two_toilet_non_attached_remark" @if($accommods)  value="{{$accommods->accommods_part_two_toilet_non_attached_remark}}" @endif class="form-control"></td>
                           </tr>
                       </tbody>
               </table>
                       ...
                       <tbody  class=" align-middle">
                           <tr>
                             ...
                             <td>
                               <select class="form-select"name="kitchen_dinings_dining_hall_rating" aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                    <option value="1"  @if(isset($kichen['kitchen_dinings_dining_hall_rating']) && $kichen['kitchen_dinings_dining_hall_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_dinings_dining_hall_rating']) && $kichen['kitchen_dinings_dining_hall_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_dinings_dining_hall_rating']) && $kichen['kitchen_dinings_dining_hall_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                           ...
                           <td>
                             <select class="form-select"name="kitchen_dinings_dining_hall_nonac_rating" aria-label="Default select example">
                                 <option selected>Open this select menu</option>
                                 <option value="1"  @if(isset($kichen['kitchen_dinings_dining_hall_nonac_rating']) && $kichen['kitchen_dinings_dining_hall_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_dinings_dining_hall_nonac_rating']) && $kichen['kitchen_dinings_dining_hall_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_dinings_dining_hall_nonac_rating']) && $kichen['kitchen_dinings_dining_hall_nonac_rating'] == "3") selected @endif >Three</option>
                               </select>
                         </td>
                             <td><input type="number"  min="0"name="kitchen_dinings_dining_hall_remarks" @if($kichen)  value="{{$kichen->kitchen_dinings_dining_hall_remarks}}" @endif  class="form-control"></td>
                           ...
                           <tr>
                               ...
                               <td><input type="number"  min="0"name="kitchen_kitchen_dining_hall_area_male" @if($kichen)  value="{{$kichen->kitchen_kitchen_dining_hall_area_male}}" @endif  class="form-control"></td>
                               ...
                               <td>
                                 <select class="form-select"name="kitchen_kitchen_dining_hall_rating" aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                     <option value="1"  @if(isset($kichen['kitchen_kitchen_dining_hall_rating']) && $kichen['kitchen_kitchen_dining_hall_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_kitchen_dining_hall_rating']) && $kichen['kitchen_kitchen_dining_hall_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_kitchen_dining_hall_rating']) && $kichen['kitchen_kitchen_dining_hall_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td><input type="number"  min="0"name="kitchen_kitchen_dining_hall_nonac_area_male" @if($kichen)  value="{{$kichen->kitchen_kitchen_dining_hall_nonac_area_male}}" @endif  class="form-control"></td>
                             ...
                             <td>
                               <select class="form-select"name="kitchen_kitchen_dining_hall_nonac_rating" aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($kichen['kitchen_kitchen_dining_hall_nonac_rating']) && $kichen['kitchen_kitchen_dining_hall_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_kitchen_dining_hall_nonac_rating']) && $kichen['kitchen_kitchen_dining_hall_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_kitchen_dining_hall_nonac_rating']) && $kichen['kitchen_kitchen_dining_hall_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0"name="kitchen_kitchen_dining_hall_remarks" @if($kichen)  value="{{$kichen->kitchen_kitchen_dining_hall_remarks}}" @endif  class="form-control"></td>
                           ...
                           <tr>
                               ...
                               <td><input type="number"  min="0"name="kitchen_store_room_dining_hall_area_male" @if($kichen)  value="{{$kichen->kitchen_store_room_dining_hall_area_male}}" @endif  class="form-control"></td>
                               ...
                               <td>
                                 <select class="form-select"name="kitchen_store_room_dining_hall_rating" aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                     <option value="1"  @if(isset($kichen['kitchen_store_room_dining_hall_rating']) && $kichen['kitchen_store_room_dining_hall_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_store_room_dining_hall_rating']) && $kichen['kitchen_store_room_dining_hall_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_store_room_dining_hall_rating']) && $kichen['kitchen_store_room_dining_hall_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td><input type="number"  min="0"name="kitchen_store_room_dining_hall_nonac_area_male" @if($kichen)  value="{{$kichen->kitchen_store_room_dining_hall_nonac_area_male}}" @endif  class="form-control"></td>
                             ...
                             <td>
                               <select class="form-select"name="kitchen_store_room_dining_hall_nonac_rating" aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($kichen['kitchen_store_room_dining_hall_nonac_rating']) && $kichen['kitchen_store_room_dining_hall_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($kichen['kitchen_store_room_dining_hall_nonac_rating']) && $kichen['kitchen_store_room_dining_hall_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($kichen['kitchen_store_room_dining_hall_nonac_rating']) && $kichen['kitchen_store_room_dining_hall_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0"name="kitchen_store_room_dining_hall_remarks" @if($kichen)  value="{{$kichen->kitchen_store_room_dining_hall_remarks}}" @endif  class="form-control"></td>
                   ...
                   <thead class="text-center align-middle">
                       ...
                       <tbody  class=" align-middle">
                           <tr>
                               ...
                               <td>
                                 <select class="form-select" name="facilities_guest_room_rating"  aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                    <option value="1"  @if(isset($other_facilities['facilities_guest_room_rating']) && $other_facilities['facilities_guest_room_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_guest_room_rating']) && $other_facilities['facilities_guest_room_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_guest_room_rating']) && $other_facilities['facilities_guest_room_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td>
                               <select class="form-select" name="facilities_guest_room_nonac_rating"  aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($other_facilities['facilities_guest_room_nonac_rating']) && $other_facilities['facilities_guest_room_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_guest_room_nonac_rating']) && $other_facilities['facilities_guest_room_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_guest_room_nonac_rating']) && $other_facilities['facilities_guest_room_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0" name="facilities_guest_room_remarks" @if($other_facilities)  value="{{$other_facilities->facilities_guest_room_remarks}}" @endif  class="form-control"></td>
                           ...
                           <tr>
                               ...
                               <td>
                                 <select class="form-select" name="facilities_recreation_hall_rating"  aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                    <option value="1"  @if(isset($other_facilities['facilities_recreation_hall_rating']) && $other_facilities['facilities_recreation_hall_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_recreation_hall_rating']) && $other_facilities['facilities_recreation_hall_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_recreation_hall_rating']) && $other_facilities['facilities_recreation_hall_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td>
                               <select class="form-select" name="facilities_recreation_hall_nonac_rating"  aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($other_facilities['facilities_recreation_hall_nonac_rating']) && $other_facilities['facilities_recreation_hall_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_recreation_hall_nonac_rating']) && $other_facilities['facilities_recreation_hall_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_recreation_hall_nonac_rating']) && $other_facilities['facilities_recreation_hall_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0" name="facilities_recreation_hall_remarks" @if($other_facilities)  value="{{$other_facilities->facilities_recreation_hall_remarks}}" @endif  class="form-control"></td>
                           ...
                           <tr>
                               ...
                               <td>
                                 <select class="form-select" name="facilities_store_room_rating"  aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                     <option value="1"  @if(isset($other_facilities['facilities_store_room_rating']) && $other_facilities['facilities_store_room_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_store_room_rating']) && $other_facilities['facilities_store_room_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_store_room_rating']) && $other_facilities['facilities_store_room_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td>
                               <select class="form-select" name="facilities_store_room_nonac_rating"  aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($other_facilities['facilities_store_room_nonac_rating']) && $other_facilities['facilities_store_room_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_store_room_nonac_rating']) && $other_facilities['facilities_store_room_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_store_room_nonac_rating']) && $other_facilities['facilities_store_room_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0" name="facilities_store_room_remarks" @if($other_facilities)  value="{{$other_facilities->facilities_store_room_remarks}}" @endif  class="form-control"></td>
                           ...
                           <tr>
                               ...
                               <td><input type="number"  min="0" name="facilities_library_area_male" @if($other_facilities)  value="{{$other_facilities->facilities_library_area_male}}" @endif  class="form-control"></td>
                               ...
                               <td>
                                 <select class="form-select" name="facilities_library_rating"  aria-label="Default select example">
                                     <option selected>Open this select menu</option>
                                     <option value="1"  @if(isset($other_facilities['facilities_library_rating']) && $other_facilities['facilities_library_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_library_rating']) && $other_facilities['facilities_library_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_library_rating']) && $other_facilities['facilities_library_rating'] == "3") selected @endif >Three</option>
                                   </select>
                             </td>
                             ...
                             <td><input type="number"  min="0" name="facilities_library_nonac_area_male" @if($other_facilities)  value="{{$other_facilities->facilities_library_nonac_area_male}}" @endif  class="form-control"></td>
                             ...
                             <td>
                               <select class="form-select" name="facilities_library_nonac_rating"  aria-label="Default select example">
                                   <option selected>Open this select menu</option>
                                   <option value="1"  @if(isset($other_facilities['facilities_library_nonac_rating']) && $other_facilities['facilities_library_nonac_rating'] == "1") selected @endif>One</option>
                                    <option value="2" @if(isset($other_facilities['facilities_library_nonac_rating']) && $other_facilities['facilities_library_nonac_rating'] == "2") selected @endif >Two</option>
                                    <option value="2" @if(isset($other_facilities['facilities_library_nonac_rating']) && $other_facilities['facilities_library_nonac_rating'] == "3") selected @endif >Three</option>
                                 </select>
                           </td>
                               <td><input type="number"  min="0" name="facilities_library_remarks" @if($other_facilities)  value="{{$other_facilities->facilities_library_remarks}}" @endif  class="form-control"></td>
                       ...
                       <tbody  class="align-middle" id="two_part_two_play_field_body">
                        ...
                        @foreach ($part_two_play_field_count as $part_two_play_key => $part_two_play_value)
                           <tr>
                               <td>
                                ...
                                <input type="hidden" name="part_two_play_field[{{ $part_two_play_key }}][id]" value="{{ $part_two_play_value->id ?? '' }}">
                                    <select class="form-select" aria-label="Default select example" name='part_two_play_field[{{ $part_two_play_key }}][discline_play_field]'>
                                        ...
                                        <option value="1" {{ 1 == $part_two_play_value->discline_play_field ? 'selected' : 'disabled'}}>One</option>
                                        <option value="2" {{ 2 == $part_two_play_value->discline_play_field ? 'selected' : 'disabled'}}>Two</option>
                                        <option value="3" {{ 3 == $part_two_play_value->discline_play_field ? 'selected' : 'disabled'}}>Three</option>
                                    </select>
                               </td>
                            ...
                            <td><input type="text" class="form-control" name='part_two_play_field[{{ $part_two_play_key }}][rating_play_field]' value="{{ $part_two_play_value->rating_play_field ?? '' }}"></td>
                            <td><input type="text" class="form-control" name='part_two_play_field[{{ $part_two_play_key }}][remark_play_field]' value="{{ $part_two_play_value->remark_play_field ?? '' }}"></td>
                             <td>
                                <a href="javascript:void(0)" class="actionbtn remove_two_play_field_remove" data-id11="{{ $part_two_play_key }}" data-db_id11="{{ $part_two_play_value->id ?? '' }}">
                        ...
                        <td><input type="text" class="form-control" name='part_two_play_field[0][rating_play_field]' ></td>
                        ...
                        @if($sport_quipment->count() > 0)
                           ...
                           <tr>
                               ...
                               <select class="form-select" aria-label="Default select example" name='two_part_two_equipment[{{ $sport_quipment_key }}][equipment_discipline]'>
                                    <option value="">Open this select menu</option>
                                    <option value="1" {{ 1 == $sport_quipment_value->equipment_discipline ? 'selected' : 'disabled'}}>One</option>
                                    <option value="2" {{ 2 == $sport_quipment_value->equipment_discipline ? 'selected' : 'disabled'}}>Two</option>
                                    <option value="3" {{ 3 == $sport_quipment_value->equipment_discipline ? 'selected' : 'disabled'}}>Three</option>
                                </select>
                               </td>
                               <td>
                                ...
                                @foreach ($sport_quipment_consumable as $sport_quipment_consumable_key => $sport_quipment_consumable_value)
                                    <tr>
                                        ...
                                        <select class="form-select" aria-label="Default select example" name='two_part_two_equipment_consumable[{{ $sport_quipment_consumable_key }}][equipment_discipline]'>
                                                <option value="">Open this select menu</option>
                                                <option value="1" {{ 1 == $sport_quipment_consumable_value->equipment_discipline ? 'selected' : 'disabled'}}>One</option>
                                                <option value="2" {{ 2 == $sport_quipment_consumable_value->equipment_discipline ? 'selected' : 'disabled'}}>Two</option>
                                                <option value="3" {{ 3 == $sport_quipment_consumable_value->equipment_discipline ? 'selected' : 'disabled'}}>Three</option>
                                            </select>
                                        </td>
                                        <td>
                       ...
                       <tbody  class="align-middle add_add_staff_body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control" name='administrative_supports[{{ $sport_quipment_consumable_key }}][ssd_2018_19]' value="{{ $sport_quipment_consumable_value->ssd_2018_19 ?? '' }}">
                            </td>
                            <td>
                                {{-- <input type="text" class="form-control" name="administrative_supports[0][ssd_2019_20]"> --}}
                                <input type="text" class="form-control" name='administrative_supports[{{ $sport_quipment_consumable_key }}][ssd_2019_20]' value="{{ $sport_quipment_consumable_value->ssd_2019_20 ?? '' }}">
                            </td>
                            <td>
                                {{-- <input type="text" class="form-control" name="administrative_supports[0][ssd_2020_21]"> --}}
                                <input type="text" class="form-control" name='administrative_supports[{{ $sport_quipment_consumable_key }}][ssd_2020_21]' value="{{ $sport_quipment_consumable_value->ssd_2020_21 ?? '' }}">
                            </td>
                            <td>
                                {{-- <input type="text" class="form-control" name="administrative_supports[0][ssd_2021_22]"> --}}
                                <input type="text" class="form-control" name='administrative_supports[{{ $sport_quipment_consumable_key }}][ssd_2021_22]' value="{{ $sport_quipment_consumable_value->ssd_2021_22 ?? '' }}">
                            </td>
                            <td>
                                {{-- <input type="text" class="form-control" name="administrative_supports[0][ssd_2022_23]"> --}}
                                <input type="text" class="form-control" name='administrative_supports[{{ $sport_quipment_consumable_key }}][ssd_2022_23]' value="{{ $sport_quipment_consumable_value->ssd_2022_23 ?? '' }}">
                            </td>
                            <td>
                        ...
                        @if($sportsciencestaffdoctor->count() > 0)
                            @foreach ($sportsciencestaffdoctor as $sportsciencestaffdoctor_key => $sportsciencestaffdoctor_value)
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="sport_science_staff_doctor[{{ $sportsciencestaffdoctor_key }}][ssd_2018_19]" value="{{ $sportsciencestaffdoctor_value->ssd_2018_19 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="sport_science_staff_doctor[{{ $sportsciencestaffdoctor_key }}][ssd_2019_20]" value="{{ $sportsciencestaffdoctor_value->ssd_2019_20 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="sport_science_staff_doctor[{{ $sportsciencestaffdoctor_key }}][ssd_2020_21]" value="{{ $sportsciencestaffdoctor_value->ssd_2020_21 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="sport_science_staff_doctor[{{ $sportsciencestaffdoctor_key }}][ssd_2021_22]" value="{{ $sportsciencestaffdoctor_value->ssd_2021_22 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="sport_science_staff_doctor[{{ $sportsciencestaffdoctor_key }}][ssd_2022_23]" value="{{ $sportsciencestaffdoctor_value->ssd_2022_23 }}">
                                    </td>
                                    <td>
                        ...
                        @else
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_designation]">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_2018_19]">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_2019_20]">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_2020_21]">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_2021_22]">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="sport_science_staff_doctor[0][ssd_2022_23]">
                                </td>
                                <td>
                        ...
                        @if($staffnutritionistchefs->count() > 0)
                            @foreach ($staffnutritionistchefs as $staffnutritionistchefs_key => $staffnutritionistchefs_value)
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="staff_nutritionist_chef[{{ $staffnutritionistchefs_key }}][snc_2018_19]"value="{{ $staffnutritionistchefs_value->snc_2018_19 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="staff_nutritionist_chef[{{ $staffnutritionistchefs_key }}][snc_2019_20]"value="{{ $staffnutritionistchefs_value->snc_2019_20 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="staff_nutritionist_chef[{{ $staffnutritionistchefs_key }}][snc_2020_21]"value="{{ $staffnutritionistchefs_value->snc_2020_21 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="staff_nutritionist_chef[{{ $staffnutritionistchefs_key }}][snc_2021_22]"value="{{ $staffnutritionistchefs_value->snc_2021_22 }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="staff_nutritionist_chef[{{ $staffnutritionistchefs_key }}][snc_2022_23]"value="{{ $staffnutritionistchefs_value->snc_2022_23 }}">
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" class="actionbtn remove_two_part_staff_nutritionist_chef" data-id4="{{ $staffnutritionistchefs_key }}" data-db_id4="{{ $staffnutritionistchefs_value->id ?? '' }}">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tbody id="two_part_residential_coaches_container" class=" align-middle">
                                ...
                                @if($parttwostrengthresidentialcoachesdisciplines->count() > 0)
                                    @foreach ($parttwostrengthresidentialcoachesdisciplines as $parttwostrengthresidentialcoachesdisciplines_key => $parttwostrengthresidentialcoachesdisciplines_value)    
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2018_19_resi_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2018_19_resi_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2018_19_resi_f]"  value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2018_19_resi_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2018_19_nr_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2018_19_nr_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2018_19_nr_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2018_19_nr_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2018_19_nr_c]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2018_19_nr_c }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2019_20_resi_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2019_20_resi_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2019_20_resi_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2019_20_resi_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2019_20_nr_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2019_20_nr_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2019_20_nr_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2019_20_nr_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2019_20_nr_c]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2019_20_nr_c }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2020_21_resi_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2020_21_resi_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2020_21_resi_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2020_21_resi_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2020_21_nr_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2020_21_nr_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2020_21_nr_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2020_21_nr_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2020_21_nr_c]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2020_21_nr_c }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_22_resi_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_22_resi_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_22_resi_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_22_resi_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_22_nr_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_22_nr_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_22_nr_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_22_nr_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_22_nr_c]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_22_nr_c }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_23_resi_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_23_resi_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_23_resi_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_23_resi_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_23_nr_m]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_23_nr_m }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_23_nr_f]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_23_nr_f }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[{{ $parttwostrengthresidentialcoachesdisciplines_key }}][strength_residential_coaches_2022_23_nr_c]" value="{{ $parttwostrengthresidentialcoachesdisciplines_value->strength_residential_coaches_2022_23_nr_c }}">
                                            </td>
                                            <td>
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2018_19_resi_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2018_19_resi_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2018_19_nr_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2018_19_nr_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2018_19_nr_c]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2019_20_resi_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2019_20_resi_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2019_20_nr_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2019_20_nr_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2019_20_nr_c]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2020_21_resi_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2020_21_resi_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2020_21_nr_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2020_21_nr_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2020_21_nr_c]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_22_resi_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_22_resi_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_22_nr_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_22_nr_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_22_nr_c]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_23_resi_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_23_resi_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_23_nr_m]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_23_nr_f]">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" style="width:80px;" name="two_part_residential_coaches[0][strength_residential_coaches_2022_23_nr_c]">
                                        </td>
                                        <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-select" aria-label="Default select example" name='two_part_two_athletes[{{ $parttwoathlete_key }}][athletes_discipline]'>
                                                    <option value="">Open this select menu</option>
                                                    <option value="1" {{ 1 == $parttwoathlete_value->athletes_discipline ? 'selected' : 'disabled'}}>One</option>
                                                    <option value="2" {{ 2 == $parttwoathlete_value->athletes_discipline ? 'selected' : 'disabled'}}>Two</option>
                                                    <option value="3" {{ 3 == $parttwoathlete_value->athletes_discipline ? 'selected' : 'disabled'}}>Three</option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name='two_part_two_athletes[{{ $parttwoathlete_key }}][athletes_no_athletes_participated]' value="{{ $parttwoathlete_value->athletes_no_athletes_participated ?? '' }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name='two_part_two_athletes[{{ $parttwoathlete_key }}][athletes_no_expenditure_incurred]' value="{{ $parttwoathlete_value->athletes_no_expenditure_incurred ?? '' }}">
                                            </td>
                                            <td>
